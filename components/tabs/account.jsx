...
export const ItemsBtn = ({text, iconName,iconBgColorClass="bg-red-500", iconColor="#d4d4d8"}) => {
    return(
        <View className="mt-3">
            <TouchableOpacity className="px-2 py-1 flex flex-row items-center bg-darkgray-200 justify-between  rounded-2xl">
